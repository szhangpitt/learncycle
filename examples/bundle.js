...
},{"./fromEvent":10,"@cycle/xstream-adapter":22,"xstream":122}],3:[function(require,module,exports){
"use strict";
var xstream_1 = require('xstream');
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var fromEvent_1 = require('./fromEvent');
...
},{"./fromEvent":10,"@cycle/xstream-adapter":22,"xstream":122}],4:[function(require,module,exports){
"use strict";
...
},{"./BodyDOMSource":2,"./DocumentDOMSource":3,"./ElementFinder":4,"./EventDelegator":5,"./fromEvent":10,"./isolate":14,"./utils":21,"@cycle/xstream-adapter":22,"matches-selector":97,"xstream":122}],8:[function(require,module,exports){
"use strict";
...
},{"./MainDOMSource":7,"./VNodeWrapper":9,"./isolateModule":15,"./modules":19,"./transposition":20,"./utils":21,"@cycle/xstream-adapter":22,"es6-map":66,"snabbdom":116,"xstream":122}],17:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var transposition_1 = require('./transposition');
...
},{"@cycle/base":1,"@cycle/xstream-adapter":22}],24:[function(require,module,exports){
/*!
...
function main(sources) {
    ...
    var newValue$ = domSource.select('.slider').events('input').map(function (ev) {
        return ev.target.value;
    });

    var state$ = props$.map(function (props) {
        return newValue$.map(function (val) {
            return {
                label: props.label,
                unit: props.unit,
                min: props.min,
    ...
    var vdom$ = state$.map(function (state) {
        return (0, _dom.div)('.labeled-slider', [(0, _dom.span)('.label', state.label + ' ' + state.value + state.unit), (0, _dom.input)('.slider', {
...
},{"@cycle/dom":13,"@cycle/xstream-run":23,"xstream":122}]},{},[123]);
